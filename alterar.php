...
<body>
 ...
 <br> <br><br><br> 
    <div class="wrapper">
        <form action="paginaalterar.php" method="post">
            ...
            <div class="input-box">   
                 ...
                 <input type="text" name="novasenha" id="senha" placeholder="<?php echo $senha?>">
  
            </div>
            
           
    
            <a href="paginaalterar.php" class="btn">Alterar</a>
